...
namespace project
{
    public partial class hisroryrejectuser : Form
    {
        public hisroryrejectuser()
        {
            InitializeComponent();
            ...
            try
            {
                ...
                cmd.CommandText = "SELECT DISTINCT order_id, username, dateorder, timeorder, moneyslip, totalprice FROM historyreject WHERE username = @username";
